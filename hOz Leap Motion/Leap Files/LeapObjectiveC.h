...
// h[Oz]
/**
 * Modified to work without ARC so it can work in 32 bit mode. 
 *
 * 1.       I'm not sure at the time I publish this code I'm allowed to distribute this file (see above Leap Motion notice)
 * 2.       Memory leaks can occur because the whole file should be checked and rewrote for MRC
 *
 */
...
/**
 *
 * From the LeapMath.h file
 *
 * Please, perform translation after rotation and scale.
 *
 */

- (void) setRotationWithAxis:(LeapVector *) axis angleRadians:(float)angleRadians;
